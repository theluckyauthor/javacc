...
/** Token Manager. */
public class ParserExpRegsTokenManager implements ParserExpRegsConstants
{
...
/** Constructor. */
public ParserExpRegsTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public ParserExpRegsTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
